...
// 阿里云配置
define('ALIYUN_ACCESS_KEY_ID', 'YOUR_ALIYUN_KEY_ID');
define('ALIYUN_ACCESS_KEY_SECRET', 'YOUR_ALIYUN_KEY_SECRET');
define('ALIYUN_REGION', 'cn-shanghai');

// 服务器公网地址（用于阿里云API回调下载临时图片）
define('SERVER_PUBLIC_URL', 'https://YOUR_DOMAIN');

// 微信小程序配置（用于 sec_check.php 登录与内容安全）
